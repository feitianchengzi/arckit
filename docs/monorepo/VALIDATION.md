...
- The sibling private `arckit-ops` repository tracks only policy/contracts; four representative plaintext and quarantine targets pass `git check-ignore` and are mode `0600`.
