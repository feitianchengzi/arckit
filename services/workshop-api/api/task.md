...
**接口**: `POST /workshop/v1/user/tasks/batch`
...
**生产环境**:
```bash
curl -X POST "https://api.feitianchengzi.com/workshop/v1/user/tasks/batch" \
  -H "Authorization: Bearer $ACCESS_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "project_id": 1,
...
**接口**: `PUT /workshop/v1/user/tasks/batch`
...
**生产环境**:
```bash
curl -X PUT "https://api.feitianchengzi.com/workshop/v1/user/tasks/batch" \
  -H "Authorization: Bearer $ACCESS_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "tasks": [
...
**生产环境**:
```bash
curl -X DELETE "https://api.feitianchengzi.com/workshop/v1/user/tasks/batch" \
  -H "Authorization: Bearer $ACCESS_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "task_ids": [1, 2, 3]
