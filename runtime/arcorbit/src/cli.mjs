...
Usage:
  ...
  arcorbit gate-result --file <runtime-result.json> [--project <path>] [--json]
  arcorbit write-ledger --file <runtime-result.json> [--project <path>] [--runtime-record-ref <arckit-runtime://runs/RUN-...>] [--dry-run] [--json]
...
function printRunSummary(result) {
  console.log(`ArcOrbit ${result.runtime_version}`);
