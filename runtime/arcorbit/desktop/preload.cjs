...
contextBridge.exposeInMainWorld("arckitDesktop", {
  ...
  confirmAutomationExternalDependency: (input) => ipcRenderer.invoke("arckit:automation-confirm-external-dependency", input),
  ...
  restoreFeedbackV2: (input) => invokeFeedbackV2("arckit:feedback-v2-restore", input),
