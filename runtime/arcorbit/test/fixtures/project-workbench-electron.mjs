...
try{
 ...
 await js(`window.workbenchBodyBefore=document.querySelector('.pw-body').firstElementChild;document.querySelector('.pw-body details').open=true;document.querySelector('[data-pw-action=sync]').click();new Promise(resolve=>setTimeout(resolve,350))`);
 ...
 await js(`document.querySelector('[data-pw-action=sync]').click();new Promise(resolve=>setTimeout(resolve,350))`);
