...
test('CLI handoff preserves the selected on-demand paths after project migration', () => {
 const prompt=buildCodexCliHandoffPrompt({caseId:'CASE-20260911-001',sceneSkillBinding:{skills:[{name:'using-arckit',skillPath:'/app/catalog/version/entry/skills/using-arckit/SKILL.md'},{name:'my-debug',skillPath:'/user/on-demand/my-debug/SKILL.md'}]}});
 assert.match(prompt,/\/app\/catalog\/version\/entry\/skills\/using-arckit\/SKILL.md/);
