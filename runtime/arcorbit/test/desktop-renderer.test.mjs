...
test("Desktop gates automation behind bounded Setup Readiness plan and confirmation IPC", async () => {
  ...
  assert.equal((main.match(/skillProvisioningManager\.assertReady\(projectRoot\)/g) || []).length, 2);
  assert.doesNotMatch(main, /setupReadinessPreflight: async \(projectRoot\)[\s\S]{0,300}skillProvisioningManager\.check/);
