...
```text
arckit/
  idea/          想法、机会、用户反馈和早期问题分析
  iteration/     迭代管理、里程碑、优先级和执行节奏
  definition/    产品规格、交互设计、视觉设计和技术方案
  memory/        agent 记忆、项目上下文索引和跨会话导航
  engineering/   工程实现、平台开发、前后端实践和编码工作流
  quality/       代码审查、测试策略、验收检查和发布质量评估
  delivery/      部署、发布、运行环境、监控和故障处理
```
...
如果一个 skill 主要帮助判断“这个方向是否值得做”，应放在这里。

### `iteration/`

用于项目迭代管理、版本节奏、里程碑规划、任务优先级和执行推进。

如果一个 skill 主要帮助决定“什么时候做、先做什么、如何推进”，应放在这里。
