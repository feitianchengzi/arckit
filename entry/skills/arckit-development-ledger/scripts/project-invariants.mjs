// Core definitions describe durable correctness, not a mandatory activity list per Loop.
// Applicability assessment may retain threatened/undetermined responsibilities with
// open Gaps while the Agent resolves only the selected independent deficit.
