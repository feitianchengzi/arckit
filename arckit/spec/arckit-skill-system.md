...
| Skill | 目录 | 作用 |
|---|---|---|
| `using-arckit` | `entry/skills/using-arckit/` | 同一 Agent 的状态驱动方法、动态 Gap 选择与执行。 |
| `arckit-development-ledger` | `entry/skills/arckit-development-ledger/` | 状态模型与语义接口、确定性验收和原子写入。 |
