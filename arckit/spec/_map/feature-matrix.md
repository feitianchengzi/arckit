...
| `agentic-software-development/runtime-automation-workspace.md` | 🟡 | Runtime 自动化工作区，定义普通待办与验收反馈双队列、同待办持久 thread、新 Run/Case、执行仲裁、completed/accepted 详情反馈进展，以及固定壳层内 Loop/Agent 优先的消息流。 |
| `agentic-software-development/arcorbit-platform-capabilities.md` | 🟡 | ArcOrbit 多产品研发平台，定义组织、产品、成员、完整待办、自动执行、两类反馈、多产品工作集和现有服务契约边界。 |
