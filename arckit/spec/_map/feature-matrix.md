...
| `agentic-software-development/runtime-automation-workspace.md` | 🟢 | Runtime 待办自动化工作区，定义待办独立持久 thread、自动续轮、同 thread Git closeout、执行去重、上下文主动压缩，以及固定壳层内 Loop/Agent 优先、工具单行化的消息流。 |
