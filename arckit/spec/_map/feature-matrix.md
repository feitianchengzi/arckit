...
| `agentic-software-development/runtime-automation-workspace.md` | 🟡 | Runtime 自动化工作区，定义持久事件唤醒、断线游标补取、降级对账、人工 Gate 保护、普通待办与验收问题双队列、同待办持久 thread 和执行仲裁。 |
...
| `agentic-software-development/arcorbit-work-management.md` | 🟡 | ArcOrbit Work 待办管理，定义多维筛选、任务树和子任务、完整详情、评论附件、受控状态操作与日常替代网页版的验收口径。 |
| `agentic-software-development/arcorbit-planned-workspaces.md` | 🟡 | ArcOrbit Chat 与计划工作空间，定义本地项目真实 Codex Chat 的会话、消息、停止、恢复和隔离边界，以及其余计划页面与 Domain Profile 职责。 |
