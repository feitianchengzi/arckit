...
| `arcorbit-distribution.md` | 🟡 | Runtime 分发、安装与 Codex Model/Level 配置，定义人工 release intent、跨平台安装包、仅关联项目可发现的离线 skills provisioning、用户级 managed target 迁移、签名和可追溯验收。 |
