...
- agentic-software-development/ Agent 软件研发协议层：定义 Arckit 面向人类、Codex 类 Agent 和多 Agent 自动化平台的软件研发协作与接力协议。⚪
  ...
  - product-concepts.md 产品概念：定义 Project State、Case、Loop、人、Desktop Runtime、Codex 类 Agent、Skill、协议层、handoff、事实、评测集和操作层。⚪ (310行)
  ...
  - controller-worker-loop.md Controller Worker Loop：定义 Project State/Case/Loop 的对话推进形态、Controller/Worker 分工、using-arckit invocation、动态路由、执行授权、report intake、状态影响判断和 ledger 写回门禁。⚪ (307行)
