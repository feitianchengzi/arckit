...
- agentic-software-development/ Agent 软件研发协议层：定义 Arckit 面向人类、Codex 类 Agent 和多 Agent 自动化平台的软件研发协作与接力协议。⚪
  ...
  - runtime-automation-workspace.md Runtime 自动化工作区：定义双队列、同待办 thread、统一待办展示标题、人工 Gate、Chat 共享消息面与逐 Gap 执行全貌。🟡 (314行)
  - arcorbit-platform-capabilities.md ArcOrbit 多产品研发平台：定义全局产品集范围、Work/Automation 筛选、Feedback 双向会话、独立滚动与共享图片查看体验，以及独立 ArcOrbit 产品反馈中心。🟡 (493行)
  - arcorbit-work-management.md ArcOrbit Work 待办管理：定义单字段正文与统一展示标题、单行任务树、Inspector 去重、评论图片独立浏览及 Automation 边界。🟡 (100行)
