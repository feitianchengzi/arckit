...
- arcorbit-distribution.md ArcOrbit 分发与安装：定义 Codex installation inventory、来源感知安装/更新、代理恢复、Model/Level 配置与生效、项目级 skills provisioning、Setup Readiness 与签名边界。🟡 (293行)
- agentic-software-development/ Agent 软件研发协议层：定义 Arckit 面向人类、Codex 类 Agent 和多 Agent 自动化平台的软件研发协作与接力协议。⚪
  ...
  - arcorbit-product-management.md Product 管理：定义仓库产品状态与资产、独立 Idea 接入、Agent 协作和 Today 来源入口。🟡 (78行)
  - arcorbit-planned-workspaces.md ArcOrbit Chat 与计划工作空间：定义按项目分组的真实 Codex Chat、新会话项目归属、共享 Conversation Surface 边界及计划工作空间职责。🟡 (182行)
