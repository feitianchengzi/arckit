...
- agentic-software-development/ Agent 软件研发协议层：定义 Arckit 面向人类、Codex 类 Agent 和多 Agent 自动化平台的软件研发协作与接力协议。⚪
  ...
  - runtime-automation-workspace.md Runtime 自动化工作区：定义普通待办与验收反馈双队列、同待办 thread 续跑、新 Case、执行仲裁、完成详情进展和低噪声消息流。🟡 (288行)
  - arcorbit-platform-capabilities.md ArcOrbit 多产品研发平台：定义组织、产品、成员、待办、执行、反馈的现有能力、保护边界与平台扩展验收。🟡 (500行)
