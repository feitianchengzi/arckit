...
Runtime Desktop 是以项目待办和验收反馈为两条独立工作来源的自动化执行工作区。用户在主页面观察当前用户可访问的项目、项目产生的待办、跨项目待办执行队列、验收反馈队列、活动 Runtime、人工事项与完成证据；Chat 仅在人工审查执行过程、提交验收问题或 Runtime 明确需要人工输入时按需出现。
