# Product 与 Today 续接探索记录

## 问题与范围

保留原 runtime/arcorbit/design/product-continuity-concept/ 的交互探索、参考材料与本地验证证据。具体候选问题、体验路径和模拟边界见 options/original/README.md。
...
- 状态：候选。
- 本次仅迁移；未重新确认其中产品、后端与视觉取舍。既有正式 product / today 页面保持各自事实。
