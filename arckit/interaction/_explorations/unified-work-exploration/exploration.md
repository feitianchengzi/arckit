...
保留原 runtime/arcorbit/design/unified-work-exploration/ 的交互探索、参考材料与本地验证证据。具体候选问题、体验路径和模拟边界见 options/original/README.md。
...
- 状态：未采纳。
- 保留原有 list / focus / attention 三个比较入口；本次选择是 project-workbench-v2，不将早期方案独立提升为正式页面。
