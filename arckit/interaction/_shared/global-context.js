...
(() => {
  ...
  window.GlobalContext={projects,sets,pages,key,get state(){return state;},scopeKey,ids,includes,change,select,remember,save,emit,href,esc,on:fn=>listeners.add(fn),before:fn=>before.add(fn),reset(){state=initial();emit();}};
})();
