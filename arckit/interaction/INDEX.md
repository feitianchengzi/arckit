...
- setup-readiness/ 环境准备页面：全局资源检查、关联项目 skills 计划、用户级迁移、事务 apply 与阻塞恢复。✅
  - default.html 环境准备线框：全局检查、项目计划、执行、完成、typed 升级迁移和失败恢复。✅ (91行)
  - interaction.md 环境准备交互：项目绑定门禁、项目 target、用户级 managed 迁移、备份恢复与异常恢复。✅ (165行)
