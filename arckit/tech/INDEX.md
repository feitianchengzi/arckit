...
- arcorbit/ ArcOrbit：Runtime Kernel、普通待办与验收反馈双队列、持久单 thread、执行仲裁、交互式 CLI 接力、Gate 与自动账本回写。✅
  ...
  - desktop-execution-solution.md Desktop Codex 会话与执行方案：定义共享 Conversation Surface、summary/detail Run 投影、局部 activity 刷新、按 ID 控制查询与执行恢复。✅ (310行)
  - platform-composition-solution.md 平台组合方案：定义统一 Task 文本投影、多产品 workset、Work/Feedback 受控图片窗口、受限 adapter 与平台 IPC。✅ (386行)
