...
- arcorbit/ ArcOrbit：Runtime Kernel、普通待办与验收反馈双队列、持久单 thread、执行仲裁、交互式 CLI 接力、Gate 与自动账本回写。✅
  - solution.md ArcOrbit 技术方案：定义认证、Automation Supervisor、双工作来源、执行仲裁、持久 Agent thread、trusted ledger 与同线程收尾。✅ (455行)
  ...
  - desktop-execution-solution.md Desktop Codex 会话与执行方案：定义自由 Chat/Automation 隔离、即时缓存投影与后台刷新、共享 Codex transport、session/thread、审批、执行租约与恢复。✅ (252行)
  - platform-composition-solution.md 平台组合方案：定义独立组织治理、多产品 workset、Work 评论图片自动加载/隔离浏览窗口、受限 Feedback adapter 与平台 IPC。✅ (368行)
