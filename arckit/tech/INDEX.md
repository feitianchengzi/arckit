...
- arckit-runtime/ Arckit Runtime：Runtime Kernel、Desktop 待办执行、持久单 thread、交互式 CLI 接力、上下文压缩、Gate 与自动账本回写。✅
  ...
  - state-condition-ledger-solution.md State Condition Ledger：定义 Project desired conditions、facts/impacts/dynamic gaps Case v4、Transition v4 与显式项目升级边界。✅ (244行)
