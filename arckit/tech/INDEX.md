...
- arcorbit/ ArcOrbit：Runtime Kernel、普通待办与验收反馈双队列、持久单 thread、执行仲裁、交互式 CLI 接力、Gate 与自动账本回写。✅
  ...
  - installer-supply-chain.md ArcOrbit 安装包供应链：定义独立 ArcOrbit 数据身份、ArcForge provider 边界、bundle 重装恢复、skills provisioning、utility Runtime host、Renderer 兼容 fuse 和回滚。✅ (336行)
