...
| `arcorbit/desktop-execution-solution.md` | ✅ | 自由 Chat 与 Automation 隔离、共享 Codex transport/Conversation Surface、结构化 Gap 全貌、Desktop session、执行租约、thread/Case binding 和恢复。 |
| `arcorbit/platform-composition-solution.md` | ✅ | Product Workspace、独立组织治理、多产品 workset、Work 多维任务树与评论附件契约、Workshop 完整分页与权限投影、受限 IPC 和双反馈线。 |
| `arcorbit/realtime-synchronization-solution.md` | ✅ | PostgreSQL 持久项目事件、提交后跨实例分发、项目 WebSocket 游标恢复、ArcOrbit 项目刷新、降级对账和人工 Gate 隔离。 |
