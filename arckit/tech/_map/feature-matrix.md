...
| `arcorbit/desktop-execution-solution.md` | ✅ | 自由 Chat 与 Automation 隔离、共享 Codex transport/Conversation Surface、Model/Level 清单与持久配置生效、Work 本地任务状态驱动、Desktop session、执行租约、thread/Case binding 和恢复。 |
